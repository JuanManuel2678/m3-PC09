...
export const Footer = () => {
  ...
  return (
    ...
    <footer className="fixed bg-[rgba(0,0,0.7)] bottom-4 text-left py-2 px-6 opacity-85 rounded-[32px] text-white backdrop-sepia-0" >
      ...
      <h4 className="m-0 flex">Prueba tecnica de React ☸ - <a href="https://github.com/JuanManuel2678/m3-PC09"> <span  className="text-[14px] text-[#7dbce6] opacity-[.8] "> JuanManuel2678</span></a></h4>
